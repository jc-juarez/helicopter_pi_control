...
title('Bilinear Transformation - Output Response');
subplot(3,1,2),plot(t,m,'b');
xlabel('Iterations');
ylabel('Output');
legend({'m(k)'},'Location','southeast')
title('Bilinear Transformation - Controller Signal');
subplot(3,1,3),plot(t,e,'r');
xlabel('Iterations');
ylabel('Output');
legend({'e(k)'},'Location','southeast')
title('Bilinear Transformation - Error Signal');
...
ylabel('Output');
legend({'r(k)','c(k)'},'Location','southeast')
title('Forward Integration Rule - Output Response');
subplot(3,1,2),plot(t,m,'b');
xlabel('Iterations');
ylabel('Output');
legend({'m(k)'},'Location','southeast')
title('Forward Integration Rule - Controller Signal');
subplot(3,1,3),plot(t,e,'r');
xlabel('Iterations');
ylabel('Output');
legend({'e(k)'},'Location','southeast')
title('Forward Integration Rule - Error Signal');
...
ylabel('Output');
legend({'r(k)','c(k)'},'Location','southeast')
title('Backward Integration Rule - Output Response');
subplot(3,1,2),plot(t,m,'b');
xlabel('Iterations');
ylabel('Output');
legend({'m(k)'},'Location','southeast')
title('Backward Integration Rule - Controller Signal');
subplot(3,1,3),plot(t,e,'r');
xlabel('Iterations');
ylabel('Output');
legend({'e(k)'},'Location','southeast')
title('Backward Integration Rule - Error Signal');
